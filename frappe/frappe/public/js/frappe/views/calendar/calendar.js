...
frappe.views.Calendar = class Calendar {
	...
	set_css() {
		...
		this.$wrapper
			...
			.attr("class", "")
			.html(`<img class="app-logo" src="/assets/erpnext/images/icons/previous.png">`);
		this.$wrapper
			.find(".fc-next-button span")
			.attr("class", "")
			.html(`<img class="app-logo" src="/assets/erpnext/images/icons/next.png">`);

		this.$wrapper.find(".fc-today-button").prepend(`<img class="app-logo p-1" src="/assets/erpnext/images/icons/sun.png">`);
