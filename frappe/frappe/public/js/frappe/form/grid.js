			...
			<div class="small form-clickable-section grid-footer">
				<div class="flex justify-between">
					<div class="grid-buttons">
						...
						<button class="grid-add-multiple-rows btn btn-xs btn-light hidden"
							style="margin-right: 4px;">
							${__("Add Multiple")}</a>
						</button>
						<!-- hack to allow firefox include this in tabs -->
						<button class="btn btn-xs btn-light grid-add-row">
							${__("Add Row")}
						</button>
					</div>
					...
					<div class="text-right">
						<a href="#" class="grid-download btn btn-xs btn-light hidden">
							${__("Download")}
						</a>
						<a href="#" class="grid-upload btn btn-xs btn-light hidden">
							${__("Upload")}
						</a>
					</div>
				</div>
